...
namespace GraphAlgos
{
    public class LcMapData
    {
        ...
        public void createPointsFor_eb12_resident()  // machine generated - do not edit
        {
            ...
            grc.LinkToPtxyz("eb12-oso14", "eb12-14-lob", 23.600, 0.000, 29.000, LinkUse.walkway, comment: ""); //  14 nn:1 nl:1
            grc.LinkToPtxyz("eb12-oso12", "eb12-12-lob", 19.000, 0.000, 29.000, LinkUse.walkway, comment: ""); //  15 nn:1 nl:1
            grc.LinkToPtxyz("eb12-oso10", "eb12-10-lob", 12.500, 0.000, 29.000, LinkUse.walkway, comment: ""); //  16 nn:1 nl:1
            grc.LinkToPtxyz("eb12-oso08", "eb12-08-lob", 8.000, 0.000, 29.000, LinkUse.walkway, comment: ""); //  17 nn:1 nl:1
            grc.LinkToPtxyz("eb12-oso01", "eb12-oso16", 30.000, 0.000, 28.000, LinkUse.walkway, comment: ""); //  18 nn:1 nl:1
            grc.LinkToPtxyz("eb12-oso16", "eb12-16-lob", 30.000, 0.000, 31.800, LinkUse.walkway, comment: ""); //  19 nn:1 nl:1
            grc.LinkToPtxyz("eb12-oso01", "eb12-oso18", 34.400, 0.000, 28.000, LinkUse.walkway, comment: ""); //  20 nn:1 nl:1
            grc.LinkToPtxyz("eb12-oso18", "eb12-18-lob", 34.400, 0.000, 31.800, LinkUse.walkway, comment: ""); //  21 nn:1 nl:1
            grc.LinkToPtxyz("eb12-oso01", "eb12-oso20", 41.000, 0.000, 28.000, LinkUse.walkway, comment: ""); //  22 nn:1 nl:1
            grc.LinkToPtxyz("eb12-oso20", "eb12-20-lob", 41.000, 0.000, 31.800, LinkUse.walkway, comment: ""); //  23 nn:1 nl:1
            grc.LinkToPtxyz("eb12-oso01", "eb12-oso22", 45.600, 0.000, 28.000, LinkUse.walkway, comment: ""); //  24 nn:1 nl:1
            grc.LinkToPtxyz("eb12-oso22", "eb12-22-lob", 45.600, 0.000, 31.800, LinkUse.walkway, comment: ""); //  25 nn:1 nl:1
