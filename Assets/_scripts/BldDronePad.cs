...
namespace CampusSimulator {
    public class BldDronePad : MonoBehaviour
    {
        ...
        public void CreateObjects()
        {
            ...
            this.padformgo = new GameObject(name + "_form_go" + instance);
            instance++;
            ...
            if (createfloor)
            {
                ...
                floor.transform.parent = padformgo.transform;
                floor.name = "floor";
...
//                    var persgo = pers.CreatePersonGo("-ava-br");// room person
                    ...
                    {
                        pogo.transform.position = padformgo.transform.position;
                    }
                    else
                    {
                        var lclc = bm.sman.lcman;
                        var nodept = lclc.GetNode(person.homeNode);
                        var roompt = lclc.GetNode(this.padNodeName);
                    ...
                    pogo.transform.SetParent(padformgo.transform);
